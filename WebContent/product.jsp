	...
	<table class="layui-table" border="0" cellspacing="0" cellpadding="0">
		<thead>
			<tr>
				...
				<th class="layui-table-col-special" data-key="1-0-1" data-field="fruitID" data-unresize="true">
				<div class="layui-table-cell laytable-cell-1-0-1">
					<span>编号</span>
				</div>
				</th>
				<th class="layui-table-col-special" data-key="1-0-2" data-field="fruitName">
				<div class="layui-table-cell laytable-cell-1-0-2">
					<span>水果名</span>
				</div>
				</th>
				<th class="layui-table-col-special" data-key="1-0-3" data-field="kind">
				<div class="layui-table-cell laytable-cell-1-0-3">
					<span>品种</span>
				</div>
				</th>
				<th class="layui-table-col-special" data-key="1-0-4" data-field="origin">
					<div class="layui-table-cell laytable-cell-1-0-4">
						<span>产地</span>
					</div>
				</th>
				<th class="layui-table-col-special" data-key="1-0-5" data-field="price">
					<div class="layui-table-cell laytable-cell-1-0-5">
						<span>单价</span>
					</div>
				</th>
				<th class="layui-table-col-special" data-key="1-0-6" data-field="introduce">
		...
		<tfoot>
			<div class="layui-box layui-laypage layui-laypage-default" id="layui-laypage-1">
				...
				<span class="layui-laypage-count">共20 条</span>
